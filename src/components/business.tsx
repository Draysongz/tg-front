...
const businessArray = [
  {
    ...
    figure: "1 000",
    coin: "/coin.webp",
    note: "Guide your team in the crypto space, making strategic decisions that drive growth and secure exclusive market advantages.",
  ...
  },
  {
    ...
    figure: "1 000",
    coin: "/coin.webp",
    note: "Master communication to effectively negotiate crypto trades, ensuring clarity and success in high-stakes market transactions.",
    btn: "Insufficient balance",
  },
  {
    name: "Negotiation",
    ...
    figure: "2 000",
    coin: "/coin.webp",
    note: "Sharpen your negotiation skills to secure favorable trading terms and maximize profits in competitive cryptocurrency markets.",
    btn: "Insufficient balance",
  },
  {
    ...
    figure: "750",
    coin: "/coin.webp",
    note: "Optimize your portfolio by managing assets effectively, ensuring sustainable growth in the volatile cryptocurrency landscape.",
    btn: "Insufficient balance",
  },
  {
    ...
    figure: "550",
    coin: "/coin.webp",
    note: "Develop strategies to mitigate risks, protecting your investments while navigating the unpredictable crypto market.",
  ...
  },
  {
    ...
    figure: "1 000",
    coin: "/coin.webp",
    note: "Craft and execute plans that capitalize on market opportunities, positioning your assets for long-term success.",
    btn: "Unlock required level first",
  },
];
